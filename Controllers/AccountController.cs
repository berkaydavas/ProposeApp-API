...
using ProposeAppAPI.Providers;
using ProposeAppAPI.Results;
...
namespace ProposeAppAPI.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> AddExternalLogin(AddExternalLoginBindingModel model)
        {
            ...
            {
                return BadRequest("Dış oturum açma hatası.");
            }
            ...
            {
                return BadRequest("Dış oturum zaten bir hesapla ilişkilendirilmiş.");
            }
        ...
        private IHttpActionResult GetErrorResult(IdentityResult result)
        {
            ...
            if (!result.Succeeded)
            {
                ...
                if (ModelState.IsValid)
                {
                    // Gönderilebilecek ModelState hatası yok, dolayısıyla boş bir BadRequest döndürdü.
                    return BadRequest();
                }
        ...
        private static class RandomOAuthStateGenerator
        {
            ...
            public static string Generate(int strengthInBits)
            {
                ...
                {
                    throw new ArgumentException("strengthInBits 8'e tam bölünebilir olmalıdır.", "strengthInBits");
                }
